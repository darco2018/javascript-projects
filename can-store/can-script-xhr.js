...
fetch('products.json')
  .then(function (response) {
    ...
    // However, a complete website would handle this error more gracefully by displaying 
    //a message on the user's screen and perhaps offering options to remedy the situation, 
...
function initialize() {
  ...
  var category = document.querySelector('#category'); // select with options
  var searchTerm = document.querySelector('#searchTerm'); // text input
  ...
  function fetchBlob(product) {
    ...
    var url = 'images/' + product.image; // product - JS object
...
/* 
    ...
    fetch(url)
      ...
      .then(function (blob) {
        ...
        //  Ctrl-/Right-clicking on an image, and selecting the "View image" option (which might vary slightly depending 
        //on what browser you are using). The object URL will be visible inside the address bar, eg
 ...
 */
      ...
      request.addEventListener("error", function(blob){
